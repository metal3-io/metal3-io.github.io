...
deploys Debian-based OCI container images directly to bare metal. It
provides:
...
- **Cloud-init integration** - Ironic configdrive data is written
  directly to the root filesystem, no separate configdrive partition
...
<details>
  <summary>Complete hardware manager source code (deb_oci_efi_lvm.py)</summary>
  <div markdown="1">
