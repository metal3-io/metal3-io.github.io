...
| NODE_HOSTNAME_FORMAT           | Node Hostname Format. Must be a format string with exactly one %d field that will be replaced by the node number.                                                                                                                                                                                                                                                 | "PREFIX%dPOSTFIX"                    | "node-%d"                                                |
